...
class Net(nn.Module):
    ...
    def forward(self, x_left, x_right, is_training):
        ...
        # print('buffer_leftF',torch.cat([buffer_left, buffer_leftT], dim=1).shape)
...
if __name__ == "__main__":
    ...
    height = (1024 // 4 // window_size + 1) * window_size
    width = (720 // 4 // window_size + 1) * window_size
    x_L = torch.randn((1, 3, 30, 90))
    x_R = torch.randn((1, 3, 30, 90))
    x = net(x_L, x_R, is_training = 1)
